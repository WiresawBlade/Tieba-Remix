...
(() => {
    ...
    function registerMenu() {
        let menuType;
        (function (menuType) {
            menuType[menuType["button"] = 0] = "button";
            menuType[menuType["switch"] = 1] = "switch";
        })(menuType || (menuType = {}));
        const greasyMenu = [
        ...
        greasyMenu.forEach(menu => {
            switch (menu[2]) {
                case menuType.button:
                    GM_registerMenuCommand(menu[1], (event) => {
                        if (event.button === 0) {
                            menu[3]();
                        }
                    });
                ...
                case menuType.switch:
                    GM_registerMenuCommand(menu[1] + "：" + switchModeString(menu[3]), (event) => {
                        if (event.button === 0) {
