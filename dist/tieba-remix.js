...
(() => {
    ...
    if (location.search == null || location.search.indexOf("pn=") == -1) {
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            (_a = fPageElem.contentWindow) === null || _a === void 0 ? void 0 : _a.addEventListener("load", () => {
            ...
            function addTiebaTags() {
                document.querySelectorAll(".lzl_cnt .at").forEach(elem => {
                    ...
                    (() => {
                        ...
                        let cengzhuCard = floorElem === null || floorElem === void 0 ? void 0 : floorElem.querySelector(".d_name .p_author_name");
                        let cengzhuObj = JSON.parse((_a = cengzhuCard === null || cengzhuCard === void 0 ? void 0 : cengzhuCard.getAttribute("data-field")) === null || _a === void 0 ? void 0 : _a.split("'").join('"'));
