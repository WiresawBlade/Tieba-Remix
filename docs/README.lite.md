...
前段时间本人忙于期末结课作业和考试，抽不出时间进行维护。暑期本人依惯例需要担任社会廉价劳动力，未来很长一段时间的更新仍将无法保障，望谅解
...
- 设置组件的高级功能中新增重置所有配置功能，该功能可以快速将脚本恢复至默认状态
- 现在 `实用工具库` 模块支持在设置中配置每个功能的开关

### 🚀 其他

- 优化了图片查看组件的滚轮缩放体验，现在在触摸板等设备上缩放图片的效果将会更自然

### 🐛 修复

- 修复了使用新版匹配模式的模块无法正常启动的问题
- 修复了自动展开长图功能只对第一页生效的错误
